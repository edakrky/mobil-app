...
export default function NewMedicine({ navigation }) {
  ...
  const handleSaveMedicine = () => {
    ...
    navigation.navigate('MyMedicines', { newMedicine: newMedicine });
    setMedicineName('');
  };
  ...
  return (
    ...
    >
      ...
      <View style={styles.formContainer}>
        ...
        <TextInput style={styles.input} placeholder="Örn: Parol" value={medicineName} onChangeText={setMedicineName} placeholderTextColor="#a0a0a0"
        />
